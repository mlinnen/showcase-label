...
<!-- squad:capabilities schema=1 specialists=3 taskTypes=3 hints=0 -->
...
| --- | --- | --- | --- |
| Mr. Pink | 🏗️ Lead | review, edit | C# / .NET 10 architecture, code review, CI/CD pipeline (GitHub Actions), WPF application design |
| Mr. Blonde | 🔧 .NET Dev | edit | C# / .NET 10, WPF / XAML, Win32 P/Invoke (CreateFile, WriteFile, CloseHandle), TSPL thermal printer… |
| Mr. Orange | 🧪 Tester | edit | xUnit test authoring, testability refactoring (extracting code-behind into testable services), edge… |

### Supported task types

🏗️ Lead, 🔧 .NET Dev, 🧪 Tester
...
- **Can:** review code and pull requests; write and modify code; write and run tests; write and maintain documentation; author and maintain CI/CD workflows
- **Cannot (no agent claims this):** security and secrets review; responsible-AI and content-safety review; cut releases and publish packages; UX and visual design; deploy to live environments
